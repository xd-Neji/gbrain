...
export async function buildChecks(
  ...
  try {
    // Use the already-connected engine instead of the module singleton.
    // PGLite CLI runs commonly use an instance engine; db.getConnection()
    // may be unset even while `connection` above succeeded.
